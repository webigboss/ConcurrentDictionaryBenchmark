// <copyright file="SignalType.cs" company="Microsoft">
...
namespace Microsoft.Substrate.CompactSignalStore.Item.Contracts.Signals
{
    ...
    /// <summary>
    /// Signal Types supported in CSS.
    /// IMPORTANT: This Enum is part of the Key stored as ulong, therefore, never change the value or the order.
    /// </summary>
